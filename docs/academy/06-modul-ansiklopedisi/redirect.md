...
**Redirect Manager** modülünün HIVE içindeki rolünü özet düzeyde öğreneceksiniz.

## Kısa cevap

301/302 yönlendirme yönetimi
...
**API endpoint:** `/api/redirect'`

<!-- AI_UPDATE_SLOT: module_redirect_detail -->

## HIVE içinde nerede kullanılır?

Panel: `/api/redirect` veya klasik modül listesinden **Redirect Manager**.
...
> 📷 Screenshot placeholder: Redirect Manager modül ekranı.
...
<!-- EKSİK_BİLGİ: redirect derin dokümantasyon -->
