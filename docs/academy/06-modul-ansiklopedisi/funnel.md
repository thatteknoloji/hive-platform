...
**Funnel Analyzer** modülünün HIVE içindeki rolünü özet düzeyde öğreneceksiniz.
...
<!-- AI_UPDATE_SLOT: module_funnel_detail -->

## HIVE içinde nerede kullanılır?

Panel: `/api/funnel` veya klasik modül listesinden **Funnel Analyzer**.
...
> 📷 Screenshot placeholder: Funnel Analyzer modül ekranı.
...
<!-- EKSİK_BİLGİ: funnel derin dokümantasyon -->
