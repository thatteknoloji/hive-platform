...
# Messenger Operasyonu

## Bu bölümde ne öğreneceksiniz?

**Messenger Operasyonu** modülünün HIVE içindeki rolünü özet düzeyde öğreneceksiniz.

## Kısa cevap

WhatsApp/Telegram mesaj
...
**API endpoint:** `/api/messenger'`

<!-- AI_UPDATE_SLOT: module_messenger_detail -->

## HIVE içinde nerede kullanılır?

Panel: `/api/messenger` veya klasik modül listesinden **Messenger Operasyonu**.
...
> 📷 Screenshot placeholder: Messenger Operasyonu modül ekranı.
...
<!-- EKSİK_BİLGİ: messenger derin dokümantasyon -->
