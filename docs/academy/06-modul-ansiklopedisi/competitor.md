...
**Competitor Intel** modülünün HIVE içindeki rolünü özet düzeyde öğreneceksiniz.
...
**API endpoint:** `/api/competitor'`

<!-- AI_UPDATE_SLOT: module_competitor_detail -->

## HIVE içinde nerede kullanılır?

Panel: `/api/competitor` veya klasik modül listesinden **Competitor Intel**.
...
> 📷 Screenshot placeholder: Competitor Intel modül ekranı.
...
<!-- EKSİK_BİLGİ: competitor derin dokümantasyon -->
