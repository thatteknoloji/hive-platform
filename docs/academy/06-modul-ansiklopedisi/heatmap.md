...
**Heatmap** modülünün HIVE içindeki rolünü özet düzeyde öğreneceksiniz.
...
<!-- AI_UPDATE_SLOT: module_heatmap_detail -->

## HIVE içinde nerede kullanılır?

Panel: `/api/heatmap` veya klasik modül listesinden **Heatmap**.
...
> 📷 Screenshot placeholder: Heatmap modül ekranı.
...
<!-- EKSİK_BİLGİ: heatmap derin dokümantasyon -->
