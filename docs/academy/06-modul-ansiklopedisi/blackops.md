...
**Full Black Ops** modülünün HIVE içindeki rolünü özet düzeyde öğreneceksiniz.

## Kısa cevap

Tüm black modülleri aktifleştirme
...
**API endpoint:** `/api/blackops'`

<!-- AI_UPDATE_SLOT: module_blackops_detail -->

## HIVE içinde nerede kullanılır?

Panel: `/api/blackops` veya klasik modül listesinden **Full Black Ops**.
...
> 📷 Screenshot placeholder: Full Black Ops modül ekranı.
...
<!-- EKSİK_BİLGİ: blackops derin dokümantasyon -->
