...
**SEOAgent** modülünün HIVE içindeki rolünü özet düzeyde öğreneceksiniz.

## Kısa cevap

Site crawl ve sayfa audit motoru
...
**API endpoint:** `/api/seoagent/crawl'`

<!-- AI_UPDATE_SLOT: module_seoagent_detail -->

## HIVE içinde nerede kullanılır?

Panel: `/api/seoagent/crawl` veya klasik modül listesinden **SEOAgent**.
...
> 📷 Screenshot placeholder: SEOAgent modül ekranı.
...
<!-- EKSİK_BİLGİ: seoagent derin dokümantasyon -->
