...
**Sitemap Generator** modülünün HIVE içindeki rolünü özet düzeyde öğreneceksiniz.
...
<!-- AI_UPDATE_SLOT: module_sitemap_detail -->

## HIVE içinde nerede kullanılır?

Panel: `/api/sitemap` veya klasik modül listesinden **Sitemap Generator**.
...
> 📷 Screenshot placeholder: Sitemap Generator modül ekranı.
...
<!-- EKSİK_BİLGİ: sitemap derin dokümantasyon -->
