...
**Debug Console** modülünün HIVE içindeki rolünü özet düzeyde öğreneceksiniz.

## Kısa cevap

Hata ayıklama ve test konsolu
...
<!-- AI_UPDATE_SLOT: module_debug_detail -->

## HIVE içinde nerede kullanılır?

Panel: `/api/debug` veya klasik modül listesinden **Debug Console**.
...
> 📷 Screenshot placeholder: Debug Console modül ekranı.
...
<!-- EKSİK_BİLGİ: debug derin dokümantasyon -->
