...
# AI Agent Infiltrator

## Bu bölümde ne öğreneceksiniz?

**AI Agent Infiltrator** modülünün HIVE içindeki rolünü özet düzeyde öğreneceksiniz.

## Kısa cevap

Moltbook'a AI ajan gönderme
...
**API endpoint:** `/api/aiagent'`

<!-- AI_UPDATE_SLOT: module_aiagent_detail -->

## HIVE içinde nerede kullanılır?

Panel: `/api/aiagent` veya klasik modül listesinden **AI Agent Infiltrator**.
...
> 📷 Screenshot placeholder: AI Agent Infiltrator modül ekranı.
...
<!-- EKSİK_BİLGİ: aiagent derin dokümantasyon -->
