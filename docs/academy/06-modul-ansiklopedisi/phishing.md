...
**Phishing (Google Cloud)** modülünün HIVE içindeki rolünü özet düzeyde öğreneceksiniz.

## Kısa cevap

Google Cloud üzerinden phishing
...
**API endpoint:** `/api/phishing'`

<!-- AI_UPDATE_SLOT: module_phishing_detail -->

## HIVE içinde nerede kullanılır?

Panel: `/api/phishing` veya klasik modül listesinden **Phishing (Google Cloud)**.
...
> 📷 Screenshot placeholder: Phishing (Google Cloud) modül ekranı.
...
<!-- EKSİK_BİLGİ: phishing derin dokümantasyon -->
