...
**Blogger Yöneticisi** modülünün HIVE içindeki rolünü özet düzeyde öğreneceksiniz.

## Kısa cevap

Google Blogger — yazı oluştur, taslak kaydet, yayınla
...
**API endpoint:** `/api/blogger'`

<!-- AI_UPDATE_SLOT: module_blogger_detail -->

## HIVE içinde nerede kullanılır?

Panel: `/api/blogger` veya klasik modül listesinden **Blogger Yöneticisi**.
...
> 📷 Screenshot placeholder: Blogger Yöneticisi modül ekranı.
...
<!-- EKSİK_BİLGİ: blogger derin dokümantasyon -->
