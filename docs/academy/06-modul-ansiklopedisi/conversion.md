...
**Conversion Tracker** modülünün HIVE içindeki rolünü özet düzeyde öğreneceksiniz.
...
**API endpoint:** `/api/conversion'`

<!-- AI_UPDATE_SLOT: module_conversion_detail -->

## HIVE içinde nerede kullanılır?

Panel: `/api/conversion` veya klasik modül listesinden **Conversion Tracker**.
...
> 📷 Screenshot placeholder: Conversion Tracker modül ekranı.
...
<!-- EKSİK_BİLGİ: conversion derin dokümantasyon -->
