...
**BrandMentions** modülünün HIVE içindeki rolünü özet düzeyde öğreneceksiniz.

## Kısa cevap

Web'de marka bahsi takibi

## Detaylı açıklama

**Modül ID:** `brandmentions`

**Grup:** 📢 Sosyal & Marka

**API endpoint:** `/api/brandmentions'`

<!-- AI_UPDATE_SLOT: module_brandmentions_detail -->

## HIVE içinde nerede kullanılır?

Panel: `/api/brandmentions` veya klasik modül listesinden **BrandMentions**.
...
> 📷 Screenshot placeholder: BrandMentions modül ekranı.
...
<!-- EKSİK_BİLGİ: brandmentions derin dokümantasyon -->
