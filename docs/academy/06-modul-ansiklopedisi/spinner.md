...
**Content Spinner** modülünün HIVE içindeki rolünü özet düzeyde öğreneceksiniz.
...
**API endpoint:** `/api/spinner'`

<!-- AI_UPDATE_SLOT: module_spinner_detail -->

## HIVE içinde nerede kullanılır?

Panel: `/api/spinner` veya klasik modül listesinden **Content Spinner**.
...
> 📷 Screenshot placeholder: Content Spinner modül ekranı.
...
<!-- EKSİK_BİLGİ: spinner derin dokümantasyon -->
