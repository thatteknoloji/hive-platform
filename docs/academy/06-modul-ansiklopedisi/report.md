...
**Report Generator** modülünün HIVE içindeki rolünü özet düzeyde öğreneceksiniz.
...
<!-- AI_UPDATE_SLOT: module_report_detail -->

## HIVE içinde nerede kullanılır?

Panel: `/api/report` veya klasik modül listesinden **Report Generator**.
...
> 📷 Screenshot placeholder: Report Generator modül ekranı.
...
<!-- EKSİK_BİLGİ: report derin dokümantasyon -->
