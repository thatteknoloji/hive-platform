...
# Penalty Recovery Kit

## Bu bölümde ne öğreneceksiniz?

**Penalty Recovery Kit** modülünün HIVE içindeki rolünü özet düzeyde öğreneceksiniz.

## Kısa cevap

Google cezası analiz ve itiraz

## Detaylı açıklama

**Modül ID:** `penalty`

**Grup:** 🛡️ Savunma & İtibar

**API endpoint:** `/api/penalty'`

<!-- AI_UPDATE_SLOT: module_penalty_detail -->

## HIVE içinde nerede kullanılır?

Panel: `/api/penalty` veya klasik modül listesinden **Penalty Recovery Kit**.
...
> 📷 Screenshot placeholder: Penalty Recovery Kit modül ekranı.
...
<!-- EKSİK_BİLGİ: penalty derin dokümantasyon -->
