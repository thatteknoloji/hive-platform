...
# Brand Mention Blaster

## Bu bölümde ne öğreneceksiniz?

**Brand Mention Blaster** modülünün HIVE içindeki rolünü özet düzeyde öğreneceksiniz.

## Kısa cevap

Toplu marka mention yayma

## Detaylı açıklama

**Modül ID:** `brandmention`

**Grup:** 📢 Sosyal & Marka

**API endpoint:** `/api/brandmention'`

<!-- AI_UPDATE_SLOT: module_brandmention_detail -->

## HIVE içinde nerede kullanılır?

Panel: `/api/brandmention` veya klasik modül listesinden **Brand Mention Blaster**.
...
> 📷 Screenshot placeholder: Brand Mention Blaster modül ekranı.
...
<!-- EKSİK_BİLGİ: brandmention derin dokümantasyon -->
