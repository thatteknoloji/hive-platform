...
**Schedule Manager** modülünün HIVE içindeki rolünü özet düzeyde öğreneceksiniz.

## Kısa cevap

Zamanlanmış görev ve cron yönetimi
...
<!-- AI_UPDATE_SLOT: module_schedule_detail -->

## HIVE içinde nerede kullanılır?

Panel: `/api/schedule` veya klasik modül listesinden **Schedule Manager**.
...
> 📷 Screenshot placeholder: Schedule Manager modül ekranı.
...
<!-- EKSİK_BİLGİ: schedule derin dokümantasyon -->
