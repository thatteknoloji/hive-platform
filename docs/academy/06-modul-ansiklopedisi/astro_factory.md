...
**Astro Site Factory** modülünün HIVE içindeki rolünü özet düzeyde öğreneceksiniz.

## Kısa cevap

Talon ve AI verileriyle SEO uyumlu Astro statik siteler üretir

## Detaylı açıklama

**Modül ID:** `astro_factory`

**Grup:** 📝 İçerik & SEO

**API endpoint:** `/api/astro_factory'`

<!-- AI_UPDATE_SLOT: module_astro_factory_detail -->

## HIVE içinde nerede kullanılır?

Panel: `/api/astro_factory` veya klasik modül listesinden **Astro Site Factory**.
...
> 📷 Screenshot placeholder: Astro Site Factory modül ekranı.
...
<!-- EKSİK_BİLGİ: astro_factory derin dokümantasyon -->
