...
**Maps Saldırı Botu** modülünün HIVE içindeki rolünü özet düzeyde öğreneceksiniz.

## Kısa cevap

Google Maps'e yorum gönderme
...
<!-- AI_UPDATE_SLOT: module_maps_detail -->

## HIVE içinde nerede kullanılır?

Panel: `/api/maps` veya klasik modül listesinden **Maps Saldırı Botu**.
...
> 📷 Screenshot placeholder: Maps Saldırı Botu modül ekranı.
...
<!-- EKSİK_BİLGİ: maps derin dokümantasyon -->
