...
**KEFEN (Catastrophe)** modülünün HIVE içindeki rolünü özet düzeyde öğreneceksiniz.

## Kısa cevap

Rakip backlink profiline müdahale
...
**API endpoint:** `/api/kefen'`

<!-- AI_UPDATE_SLOT: module_kefen_detail -->

## HIVE içinde nerede kullanılır?

Panel: `/api/kefen` veya klasik modül listesinden **KEFEN (Catastrophe)**.
...
> 📷 Screenshot placeholder: KEFEN (Catastrophe) modül ekranı.
...
<!-- EKSİK_BİLGİ: kefen derin dokümantasyon -->
