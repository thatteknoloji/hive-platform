...
**Notification Center** modülünün HIVE içindeki rolünü özet düzeyde öğreneceksiniz.

## Kısa cevap

Bildirim merkezi ve yönetimi

## Detaylı açıklama

**Modül ID:** `notification`

**Grup:** ⚙️ Altyapı & Yönetim

**API endpoint:** `/api/notification'`

<!-- AI_UPDATE_SLOT: module_notification_detail -->

## HIVE içinde nerede kullanılır?

Panel: `/api/notification` veya klasik modül listesinden **Notification Center**.
...
> 📷 Screenshot placeholder: Notification Center modül ekranı.
...
<!-- EKSİK_BİLGİ: notification derin dokümantasyon -->
