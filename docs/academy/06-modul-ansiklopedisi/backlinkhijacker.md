---
title: "Backlink Hijacker"
slug: "backlinkhijacker"
...
**Backlink Hijacker** modülünün HIVE içindeki rolünü özet düzeyde öğreneceksiniz.

## Kısa cevap

Kırık backlinkleri çalma

## Detaylı açıklama

**Modül ID:** `backlinkhijacker`

**Grup:** ⚔️ Müdahale & Saldırı

**API endpoint:** `/api/backlinkhijacker'`

<!-- AI_UPDATE_SLOT: module_backlinkhijacker_detail -->

## HIVE içinde nerede kullanılır?

Panel: `/api/backlinkhijacker` veya klasik modül listesinden **Backlink Hijacker**.
...
> 📷 Screenshot placeholder: Backlink Hijacker modül ekranı.
...
<!-- EKSİK_BİLGİ: backlinkhijacker derin dokümantasyon -->
