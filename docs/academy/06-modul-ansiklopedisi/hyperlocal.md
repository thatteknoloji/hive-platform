---
title: "Hyperlocal Hikaye Üretici"
slug: "hyperlocal"
...
# Hyperlocal Hikaye Üretici

## Bu bölümde ne öğreneceksiniz?

**Hyperlocal Hikaye Üretici** modülünün HIVE içindeki rolünü özet düzeyde öğreneceksiniz.

## Kısa cevap

Yerel hikaye ve içerik üretimi
...
**API endpoint:** `/api/hyperlocal'`

<!-- AI_UPDATE_SLOT: module_hyperlocal_detail -->

## HIVE içinde nerede kullanılır?

Panel: `/api/hyperlocal` veya klasik modül listesinden **Hyperlocal Hikaye Üretici**.
...
> 📷 Screenshot placeholder: Hyperlocal Hikaye Üretici modül ekranı.
...
<!-- EKSİK_BİLGİ: hyperlocal derin dokümantasyon -->
