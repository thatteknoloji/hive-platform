...
**Link Builder** modülünün HIVE içindeki rolünü özet düzeyde öğreneceksiniz.

## Kısa cevap

Backlink inşa ve outreach

## Detaylı açıklama

**Modül ID:** `linkbuilder`

**Grup:** 📝 İçerik & SEO

**API endpoint:** `/api/linkbuilder'`

<!-- AI_UPDATE_SLOT: module_linkbuilder_detail -->

## HIVE içinde nerede kullanılır?

Panel: `/api/linkbuilder` veya klasik modül listesinden **Link Builder**.
...
> 📷 Screenshot placeholder: Link Builder modül ekranı.
...
<!-- EKSİK_BİLGİ: linkbuilder derin dokümantasyon -->
