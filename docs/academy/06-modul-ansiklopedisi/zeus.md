...
**Zeus'un Yıldırımı** modülünün HIVE içindeki rolünü özet düzeyde öğreneceksiniz.

## Kısa cevap

Parasite SEO – Web 2.0 istilası
...
**API endpoint:** `/api/zeus'`

<!-- AI_UPDATE_SLOT: module_zeus_detail -->

## HIVE içinde nerede kullanılır?

Panel: `/api/zeus` veya klasik modül listesinden **Zeus'un Yıldırımı**.
...
> 📷 Screenshot placeholder: Zeus'un Yıldırımı modül ekranı.
...
<!-- EKSİK_BİLGİ: zeus derin dokümantasyon -->
