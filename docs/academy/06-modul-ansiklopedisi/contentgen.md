...
**Content Generator** modülünün HIVE içindeki rolünü özet düzeyde öğreneceksiniz.

## Kısa cevap

Şablon bazlı makale oluşturma
...
**API endpoint:** `/api/contentgen'`

<!-- AI_UPDATE_SLOT: module_contentgen_detail -->

## HIVE içinde nerede kullanılır?

Panel: `/api/contentgen` veya klasik modül listesinden **Content Generator**.
...
> 📷 Screenshot placeholder: Content Generator modül ekranı.
...
<!-- EKSİK_BİLGİ: contentgen derin dokümantasyon -->
