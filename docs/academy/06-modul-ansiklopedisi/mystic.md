...
**Mystic Return** modülünün HIVE içindeki rolünü özet düzeyde öğreneceksiniz.

## Kısa cevap

Spam backlink tespit ve müdahale
...
**API endpoint:** `/api/mystic/tara'`

<!-- AI_UPDATE_SLOT: module_mystic_detail -->

## HIVE içinde nerede kullanılır?

Panel: `/api/mystic/tara` veya klasik modül listesinden **Mystic Return**.
...
> 📷 Screenshot placeholder: Mystic Return modül ekranı.
...
<!-- EKSİK_BİLGİ: mystic derin dokümantasyon -->
