...
**User Behavior** modülünün HIVE içindeki rolünü özet düzeyde öğreneceksiniz.
...
**Modül ID:** `userbehavior`

**Grup:** 🤖 AI & Veri

**API endpoint:** `/api/userbehavior'`

<!-- AI_UPDATE_SLOT: module_userbehavior_detail -->

## HIVE içinde nerede kullanılır?

Panel: `/api/userbehavior` veya klasik modül listesinden **User Behavior**.
...
> 📷 Screenshot placeholder: User Behavior modül ekranı.
...
<!-- EKSİK_BİLGİ: userbehavior derin dokümantasyon -->
