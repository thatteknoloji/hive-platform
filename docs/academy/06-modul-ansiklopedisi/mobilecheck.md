...
**Mobile Checker** modülünün HIVE içindeki rolünü özet düzeyde öğreneceksiniz.
...
**Modül ID:** `mobilecheck`

**Grup:** 📝 İçerik & SEO

**API endpoint:** `/api/mobilecheck'`

<!-- AI_UPDATE_SLOT: module_mobilecheck_detail -->

## HIVE içinde nerede kullanılır?

Panel: `/api/mobilecheck` veya klasik modül listesinden **Mobile Checker**.
...
> 📷 Screenshot placeholder: Mobile Checker modül ekranı.
...
<!-- EKSİK_BİLGİ: mobilecheck derin dokümantasyon -->
