...
**WordPress Site Manager** modülünün HIVE içindeki rolünü özet düzeyde öğreneceksiniz.

## Kısa cevap

Multisite yönetimi, domain & subdomain yöneticisi
...
<!-- AI_UPDATE_SLOT: module_wordpress_detail -->

## HIVE içinde nerede kullanılır?

Panel: `/api/wordpress` veya klasik modül listesinden **WordPress Site Manager**.
...
> 📷 Screenshot placeholder: WordPress Site Manager modül ekranı.
...
<!-- EKSİK_BİLGİ: wordpress derin dokümantasyon -->
